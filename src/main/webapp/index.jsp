    ...
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                ...
                <a class="brand" href="#">
                    <span>Lavanya<span class="accent">Shop</span></span>
                </a>
            </div>
    ...
    <footer>
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                <div style="font-weight:700;font-size:18px">LavanyaShop</div>
        ...
        <div style="text-align:center;margin-top:22px;color:var(--muted);font-size:13px">© <span id="year"></span> LavanyaShop. All rights reserved.</div>
    </footer>
